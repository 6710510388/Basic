// ================================================================
//  main.js  —  ฉบับแก้ไขเพื่อให้ Deploy ผ่าน
// ================================================================

/* ── Apply theme colours from data.js ── */
function applyTheme() {
  if (typeof DATA === 'undefined') return; // กัน Error ถ้า DATA ยังไม่มา
...
function burstSparks() {
  ...
  const colors = [DATA.themeColor, DATA.accentColor, '#f0d585', '#ffffff', '#ffcfa0'];
  for (let i = 0; i < 30; i++) {
...
function initMenu() {
  document.getElementById('menu-title').textContent = 'ยินดีต้อนรับ ' + DATA.coupleNames;
}
...
function initCountdown() {
  ...
  function tick() {
    ...
    if (diff <= 0) {
      ...
      document.getElementById('cd-message').textContent = '🎉 วันนี้คือวันครบรอบ!';
...
// 🚀 ย้ายการรันฟังก์ชันมาไว้ที่นี่เพื่อให้มั่นใจว่าหน้าเว็บโหลดเสร็จก่อน
